...
public enum ClearColors{
    ...
    static let Brownish: MTLClearColor = MTLClearColor(red: 0.6, green: 0.4, blue: 0.3, alpha: 1)
}

class Preferences {
    
    public static var ClearColor: MTLClearColor = ClearColors.Brownish
    ...
    public static var StartScene: SceneType = SceneType.CubesScene
}
